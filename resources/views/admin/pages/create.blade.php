    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_title') ? 'is-invalid' : '' }}" type="text" name="home_title" id="home_title" value="{{ old('home_title', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('home_description') ? 'is-invalid' : '' }}" name="home_description" id="home_description">{!! old('home_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_button_text') ? 'is-invalid' : '' }}" type="text" name="home_button_text" id="home_button_text" value="{{ old('home_button_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('about_us_header') ? 'is-invalid' : '' }}" type="text" name="about_us_header" id="about_us_header" value="{{ old('about_us_header', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_us_description') ? 'is-invalid' : '' }}" name="about_us_description" id="about_us_description">{{ old('about_us_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mission_header') ? 'is-invalid' : '' }}" type="text" name="mission_header" id="mission_header" value="{{ old('mission_header', 'Mission') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('mission_description') ? 'is-invalid' : '' }}" name="mission_description" id="mission_description">{{ old('mission_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vision_header') ? 'is-invalid' : '' }}" type="text" name="vision_header" id="vision_header" value="{{ old('vision_header', 'Vision') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('vision_description') ? 'is-invalid' : '' }}" name="vision_description" id="vision_description">{{ old('vision_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gallery_or_portfolio_title') ? 'is-invalid' : '' }}" type="text" name="gallery_or_portfolio_title" id="gallery_or_portfolio_title" value="{{ old('gallery_or_portfolio_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gallery_or_portfolio_description') ? 'is-invalid' : '' }}" type="text" name="gallery_or_portfolio_description" id="gallery_or_portfolio_description" value="{{ old('gallery_or_portfolio_description', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('booking_title') ? 'is-invalid' : '' }}" type="text" name="booking_title" id="booking_title" value="{{ old('booking_title', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('booking_title_description') ? 'is-invalid' : '' }}" name="booking_title_description" id="booking_title_description">{{ old('booking_title_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('booking_title_address') ? 'is-invalid' : '' }}" type="text" name="booking_title_address" id="booking_title_address" value="{{ old('booking_title_address', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('booking_description_address') ? 'is-invalid' : '' }}" type="text" name="booking_description_address" id="booking_description_address" value="{{ old('booking_description_address', '') }}">
